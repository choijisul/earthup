...
<body>
    ...
    <!-- 중간 부분 설명 -->
    <div class="context-camera">
        <p id="context-title-1">어썹은 손 쉬운 정보 제공을 도와요!</p>
        <p id="context-1">가끔씩 재활용 쓰레기를 버릴 때 이게 종이인지 일반 쓰레기인지 
    ...
    <div class="context-flogging">
        <p id="context-title-2">플로깅 모임에 직접 참여해봐요!</p>
        <p id="context-2">플로깅에 대해서 아시나요? <br>
    ...
    <div class="context-flogging">
        <p id="context-title-2">더 자세하게 알고 싶을 때는 키워드 검색을 해봐요!</p>
        <p id="context-2">키워드를 입력하여 더 자세하게 쓰레기 버리는 방법을 알 수 있습니다. <br>
